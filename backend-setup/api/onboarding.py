    ...
    try:
        ...
        if data.get('smsEnabled') and data.get('smsPhoneNumber'):
            ...
            sms_service.send_sms(
                ...
                "Your AI Receptionist SMS notifications have been enabled."
            )
...
@onboarding_bp.route('/<customer_id>/test-sms', methods=['POST'])
def send_test_sms(customer_id):
    """Send a test SMS."""
    try:
        data = request.get_json()
        phone_number = data.get('phoneNumber') or data.get('smsPhoneNumber')
