    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="relative h-screen flex items-center overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4 text-center text-white">
          <h1 className="text-6xl font-bold mb-6">Never Miss a Customer Call Again</h1>
          <p className="text-2xl mb-8 opacity-95 max-w-3xl mx-auto">
            Your AI receptionist answers calls 24/7, schedules appointments, answers questions, and
            qualifies leads—while you focus on the work.
          </p>
          <p className="text-xl mb-12 opacity-90 max-w-2xl mx-auto">
            Perfect for plumbers, dentists, carpenters, electricians, contractors, and any service
            business that gets too many calls.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-white p-8 rounded-lg shadow-md border-l-4 border-red-500">
              ...
              <p className="text-gray-700">
                For every missed call, customers call your competitors. Studies show 70% of callers
                who get voicemail will call someone else.
              </p>
            </div>
            <div className="bg-white p-8 rounded-lg shadow-md border-l-4 border-blue-500">
              ...
              <p className="text-gray-700">
                Your customers get instant answers. Appointments get booked. Leads get qualified.
                All while you focus on the actual work.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="p-8 border border-gray-200 rounded-lg hover:shadow-lg transition">
              ...
              <p className="text-gray-600">
                Never let a call go to voicemail again. Your customers get a real conversation
                instantly, 24/7.
              </p>
            </div>
            <div className="p-8 border border-gray-200 rounded-lg hover:shadow-lg transition">
              ...
              <p className="text-gray-600">
                Customers can schedule appointments with their availability. No back-and-forth. No
                double booking.
              </p>
            </div>
            <div className="p-8 border border-gray-200 rounded-lg hover:shadow-lg transition">
              ...
              <p className="text-gray-600">
                Get info before you call back. Location, job scope, timeline, budget. You know what
                to expect.
              </p>
            </div>
            <div className="p-8 border border-gray-200 rounded-lg hover:shadow-lg transition">
              ...
              <p className="text-gray-600">
                Customizable AI personality. Talks your way. Your customers don't know they're not
                talking to a human.
              </p>
            </div>
            <div className="p-8 border border-gray-200 rounded-lg hover:shadow-lg transition">
              ...
              <p className="text-gray-600">
                See every call, transcripts, and summaries. Know what customers are asking. Make
            ...
            <div className="p-8 border border-gray-200 rounded-lg hover:shadow-lg transition">
              ...
              <p className="text-gray-600">
                Connect your phone number in minutes. No complex integrations. AI starts working
                immediately.
              </p>
            </div>
          </div>
      ...
      <div className="bg-blue-600 text-white py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-sm opacity-75 mt-4">
            Plumbers, dentists, carpenters, electricians, contractors—get instant customer answers
            24/7
          </p>
        </div>
      </div>
